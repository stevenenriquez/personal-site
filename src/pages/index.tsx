    ...
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-black p-10">
        ...
        <p className="text-white text-xl sm:text-2xl mt-12 sm:mt-24 mb-12 lg:w-1/3 md:w-1/2 w-3/4 text-center">
          I&apos;m a full stack web developer from Arizona 🌅 <br/><br/>I&apos;ll be showcasing my personal projects, photography, and also writing about topics that interest me. If you&apos;d like, follow me on any of the social media linked below. Thanks for stopping by.
        </p>
        <SocialLinks />
      </main>
    </>
